...
var ReactiveElement = class extends HTMLElement {
  ...
  static addInitializer(initializer) {
    var _a8;
    this.finalize();
    ((_a8 = this._initializers) !== null && _a8 !== void 0 ? _a8 : this._initializers = []).push(initializer);
  }
  /**
      ...
      if (descriptor !== void 0) {
        ...
        if (DEV_MODE) {
          if (!this.hasOwnProperty("__reactivePropertyKeys")) {
            this.__reactivePropertyKeys = new Set((_a8 = this.__reactivePropertyKeys) !== null && _a8 !== void 0 ? _a8 : []);
          }
  ...
  __initialize() {
    ...
    this.requestUpdate();
    (_a8 = this.constructor._initializers) === null || _a8 === void 0 ? void 0 : _a8.forEach((i) => i(this));
  }
  /**
  ...
  addController(controller) {
    var _a8, _b7;
    ((_a8 = this.__controllers) !== null && _a8 !== void 0 ? _a8 : this.__controllers = []).push(controller);
    if (this.renderRoot !== void 0 && this.isConnected) {
      (_b7 = controller.hostConnected) === null || _b7 === void 0 ? void 0 : _b7.call(controller);
    }
  }
  /**
  ...
  removeController(controller) {
    var _a8;
    (_a8 = this.__controllers) === null || _a8 === void 0 ? void 0 : _a8.splice(this.__controllers.indexOf(controller) >>> 0, 1);
  }
  /**
  ...
  createRenderRoot() {
    var _a8;
    const renderRoot = (_a8 = this.shadowRoot) !== null && _a8 !== void 0 ? _a8 : this.attachShadow(this.constructor.shadowRootOptions);
  ...
  connectedCallback() {
    ...
    (_a8 = this.__controllers) === null || _a8 === void 0 ? void 0 : _a8.forEach((c) => {
      var _a9;
      return (_a9 = c.hostConnected) === null || _a9 === void 0 ? void 0 : _a9.call(c);
    });
  }
  /**
  ...
  disconnectedCallback() {
    ...
    (_a8 = this.__controllers) === null || _a8 === void 0 ? void 0 : _a8.forEach((c) => {
      var _a9;
      return (_a9 = c.hostDisconnected) === null || _a9 === void 0 ? void 0 : _a9.call(c);
    });
  }
  /**
  ...
  __propertyToAttribute(name, value, options = defaultPropertyDeclaration) {
    ...
    if (attr !== void 0 && options.reflect === true) {
      const converter = ((_a8 = options.converter) === null || _a8 === void 0 ? void 0 : _a8.toAttribute) !== void 0 ? options.converter : defaultConverter;
  ...
  _$attributeToProperty(name, value) {
    ...
    if (propName !== void 0 && this.__reflectingProperty !== propName) {
      ...
      const converter = typeof options.converter === "function" ? { fromAttribute: options.converter } : ((_a8 = options.converter) === null || _a8 === void 0 ? void 0 : _a8.fromAttribute) !== void 0 ? options.converter : defaultConverter;
  ...
  performUpdate() {
    ...
    if (!this.hasUpdated) {
      if (DEV_MODE) {
        ...
        (_a8 = this.constructor.__reactivePropertyKeys) === null || _a8 === void 0 ? void 0 : _a8.forEach((p) => {
          var _a9;
          if (this.hasOwnProperty(p) && !((_a9 = this.__instanceProperties) === null || _a9 === void 0 ? void 0 : _a9.has(p))) {
    ...
    try {
      ...
      if (shouldUpdate) {
        ...
        (_b7 = this.__controllers) === null || _b7 === void 0 ? void 0 : _b7.forEach((c) => {
          var _a9;
          return (_a9 = c.hostUpdate) === null || _a9 === void 0 ? void 0 : _a9.call(c);
        });
  ...
  _$didUpdate(changedProperties) {
    ...
    (_a8 = this.__controllers) === null || _a8 === void 0 ? void 0 : _a8.forEach((c) => {
      var _a9;
      return (_a9 = c.hostUpdated) === null || _a9 === void 0 ? void 0 : _a9.call(c);
    });
    if (!this.hasUpdated) {
...
function resolveDirective(part, value, parent = part, attributeIndex) {
  ...
  let currentDirective = attributeIndex !== void 0 ? (_a8 = parent.__directives) === null || _a8 === void 0 ? void 0 : _a8[attributeIndex] : parent.__directive;
  const nextDirectiveConstructor = isPrimitive(value) ? void 0 : (
    // This property needs to remain unminified.
    value["_$litDirective$"]
  );
  if ((currentDirective === null || currentDirective === void 0 ? void 0 : currentDirective.constructor) !== nextDirectiveConstructor) {
    (_b7 = currentDirective === null || currentDirective === void 0 ? void 0 : currentDirective["_$notifyDirectiveConnectionChanged"]) === null || _b7 === void 0 ? void 0 : _b7.call(currentDirective, false);
    ...
    if (attributeIndex !== void 0) {
      ((_c6 = (_d4 = parent).__directives) !== null && _c6 !== void 0 ? _c6 : _d4.__directives = [])[attributeIndex] = currentDirective;
    } else {
...
var TemplateInstance = class {
  ...
  _clone(options) {
    ...
    const fragment = ((_a8 = options === null || options === void 0 ? void 0 : options.creationScope) !== null && _a8 !== void 0 ? _a8 : d).importNode(content, true);
...
var ChildPart = class _ChildPart {
  constructor(startNode, endNode, parent, options) {
    ...
    this.__isConnected = (_a8 = options === null || options === void 0 ? void 0 : options.isConnected) !== null && _a8 !== void 0 ? _a8 : true;
    if (ENABLE_EXTRA_SECURITY_HOOKS) {
  ...
  get _$isConnected() {
    var _a8, _b7;
    return (_b7 = (_a8 = this._$parent) === null || _a8 === void 0 ? void 0 : _a8._$isConnected) !== null && _b7 !== void 0 ? _b7 : this.__isConnected;
  }
  /**
  ...
  _$setValue(value, directiveParent = this) {
    ...
    if (isPrimitive(value)) {
      ...
      if (DEV_MODE2 && ((_a8 = this.options) === null || _a8 === void 0 ? void 0 : _a8.host) === value) {
  ...
  _commitNode(value) {
    ...
    if (this._$committedValue !== value) {
      ...
      if (ENABLE_EXTRA_SECURITY_HOOKS && sanitizerFactoryInternal !== noopSanitizer) {
        const parentNodeName = (_a8 = this._$startNode.parentNode) === null || _a8 === void 0 ? void 0 : _a8.nodeName;
  ...
  _commitTemplateResult(result) {
    ...
    if (((_a8 = this._$committedValue) === null || _a8 === void 0 ? void 0 : _a8._$template) === template) {
      debugLogEvent2 === null || debugLogEvent2 === void 0 ? void 0 : debugLogEvent2({
  ...
  _$clear(start = wrap(this._$startNode).nextSibling, from) {
    var _a8;
    (_a8 = this._$notifyConnectionChanged) === null || _a8 === void 0 ? void 0 : _a8.call(this, false, true, from);
  ...
  setConnected(isConnected) {
    ...
    if (this._$parent === void 0) {
      ...
      (_a8 = this._$notifyConnectionChanged) === null || _a8 === void 0 ? void 0 : _a8.call(this, isConnected);
    } else if (DEV_MODE2) {
...
var EventPart = class extends AttributePart {
  ...
  _$setValue(newListener, directiveParent = this) {
    var _a8;
    newListener = (_a8 = resolveDirective(this, newListener, directiveParent, 0)) !== null && _a8 !== void 0 ? _a8 : nothing;
  ...
  handleEvent(event) {
    ...
    if (typeof this._$committedValue === "function") {
      this._$committedValue.call((_b7 = (_a8 = this.options) === null || _a8 === void 0 ? void 0 : _a8.host) !== null && _b7 !== void 0 ? _b7 : this.element, event);
    } else {
...
var render = (value, container, options) => {
  ...
  const partOwnerNode = (_a8 = options === null || options === void 0 ? void 0 : options.renderBefore) !== null && _a8 !== void 0 ? _a8 : container;
  ...
  if (part === void 0) {
    const endNode = (_b7 = options === null || options === void 0 ? void 0 : options.renderBefore) !== null && _b7 !== void 0 ? _b7 : null;
...
var wrap2 = ENABLE_SHADYDOM_NOPATCH2 && ((_b3 = global4.ShadyDOM) === null || _b3 === void 0 ? void 0 : _b3.inUse) && ((_c3 = global4.ShadyDOM) === null || _c3 === void 0 ? void 0 : _c3.noPatch) === true ? global4.ShadyDOM.wrap : (node) => node;
...
var d2 = NODE_MODE4 && global4.document === void 0 ? {
  createTreeWalker() {
    return {};
  }
} : document;
...
var tag2 = (type) => (strings, ...values) => {
  if (DEV_MODE3 && strings.some((s) => s === void 0)) {
    console.warn("Some template strings are undefined.\nThis is probably caused by illegal octal escape sequences.");
  }
  return {
    // This property needs to remain unminified.
...
var Template2 = class _Template {
  constructor({ strings, ["_$litType$"]: type }, options) {
    ...
    debugLogEvent3 === null || debugLogEvent3 === void 0 ? void 0 : debugLogEvent3({
      kind: "template prep",
      template: this,
      clonableTemplate: this.el,
      parts: this.parts,
...
var TemplateInstance2 = class {
  ...
  _clone(options) {
    var _a8;
    const { el: { content }, parts } = this._$template;
    const fragment = ((_a8 = options === null || options === void 0 ? void 0 : options.creationScope) !== null && _a8 !== void 0 ? _a8 : d2).importNode(content, true);
...
var ChildPart2 = class _ChildPart {
  ...
  _$setValue(value, directiveParent = this) {
    ...
    if (isPrimitive2(value)) {
      ...
      if (DEV_MODE3 && ((_a8 = this.options) === null || _a8 === void 0 ? void 0 : _a8.host) === value) {
        this._commitText(`[probable mistake: rendered a template's host in itself (commonly caused by writing \${this} in a template]`);
        console.warn(`Attempted to render the template host`, value, `inside itself. This is almost always a mistake, and in dev mode `, `we render some warning text. In production however, we'll `, `render it, which will usually result in an error, and sometimes `, `in the element disappearing from the DOM.`);
        return;
      }
...
var EventPart2 = class extends AttributePart2 {
  constructor(element, name, strings, parent, options) {
    ...
    if (DEV_MODE3 && this.strings !== void 0) {
      throw new Error(`A \`<${element.localName}>\` has a \`@${name}=...\` listener with invalid content. Event listeners in templates must have exactly one expression and no surrounding text.`);
    }
  }
  // EventPart does not use the base _$setValue/_resolveValue implementation
  ...
  _$setValue(newListener, directiveParent = this) {
    var _a8;
    newListener = (_a8 = resolveDirective2(this, newListener, directiveParent, 0)) !== null && _a8 !== void 0 ? _a8 : nothing2;
...
polyfillSupport3 === null || polyfillSupport3 === void 0 ? void 0 : polyfillSupport3(Template2, ChildPart2);
...
var LitElement = class extends ReactiveElement {
  ...
  createRenderRoot() {
    ...
    (_a8 = (_b7 = this.renderOptions).renderBefore) !== null && _a8 !== void 0 ? _a8 : _b7.renderBefore = renderRoot.firstChild;
    return renderRoot;
  }
  /**
   * Updates the element. This method reflects property values to attributes
  ...
  connectedCallback() {
    var _a8;
    super.connectedCallback();
    (_a8 = this.__childPart) === null || _a8 === void 0 ? void 0 : _a8.setConnected(true);
  }
  /**
  ...
  disconnectedCallback() {
    var _a8;
    super.disconnectedCallback();
    (_a8 = this.__childPart) === null || _a8 === void 0 ? void 0 : _a8.setConnected(false);
  }
  /**
...
polyfillSupport4 === null || polyfillSupport4 === void 0 ? void 0 : polyfillSupport4({ LitElement });
if (DEV_MODE4) {
...
var _a5, _b5, _c5;
_c5 = hookSymbol, _b5 = effectsSymbol, _a5 = layoutEffectsSymbol;
var State = class {
...
var BaseScheduler = class {
  constructor(renderer, host) {
    ...
    __publicField(this, "_updateQueued");
...
function makeComponent(render3) {
  class Scheduler2 extends BaseScheduler {
    constructor(renderer, frag, host) {
      super(renderer, host || frag);
      __publicField(this, "frag");
      this.frag = frag;
    }
    commit(result) {
      render3(result, this.frag);
    }
  }
...
function makeContext(component2) {
  return (defaultValue) => {
    const Context = {
      ...
      Consumer: component2(function({ render: render3 }) {
        const context = useContext(Context);
        return render3(context);
      }),
      defaultValue
    };
    return Context;
...
var HauntedControllerHost = class {
  constructor(count, kick) {
    ...
    __publicField(this, "kick");
    __publicField(this, "_controllers", []);
    __publicField(this, "_updatePending", true);
    __publicField(this, "_updateCompletePromise");
    __publicField(this, "_resolveUpdate");
    this.count = count;
    this.kick = kick;
...
var useRef = (initialValue) => useMemo(() => ({
  current: initialValue
}), []);

// node_modules/haunted/lib/core.js
function haunted({ render: render3 }) {
  const component2 = makeComponent(render3);
...
var wrap3 = ENABLE_SHADYDOM_NOPATCH3 && ((_a7 = window.ShadyDOM) === null || _a7 === void 0 ? void 0 : _a7.inUse) && ((_b6 = window.ShadyDOM) === null || _b6 === void 0 ? void 0 : _b6.noPatch) === true ? window.ShadyDOM.wrap : (node) => node;
...
var notifyChildrenConnectedChanged = (parent, isConnected) => {
  ...
  for (const obj of children) {
    (_b7 = (_a8 = obj)["_$notifyDirectiveConnectionChanged"]) === null || _b7 === void 0 ? void 0 : _b7.call(_a8, isConnected, false);
...
var installDisconnectAPI = (obj) => {
  ...
  if (obj.type == PartType.CHILD) {
    (_a8 = (_c6 = obj)._$notifyConnectionChanged) !== null && _a8 !== void 0 ? _a8 : _c6._$notifyConnectionChanged = notifyChildPartConnectedChanged;
    (_b7 = (_d4 = obj)._$reparentDisconnectables) !== null && _b7 !== void 0 ? _b7 : _d4._$reparentDisconnectables = reparentDisconnectables;
  }
};
var AsyncDirective = class extends Directive {
  ...
  ["_$notifyDirectiveConnectionChanged"](isConnected, isClearingDirective = true) {
    ...
    if (isConnected !== this.isConnected) {
      ...
      if (isConnected) {
        (_a8 = this.reconnected) === null || _a8 === void 0 ? void 0 : _a8.call(this);
      } else {
        (_b7 = this.disconnected) === null || _b7 === void 0 ? void 0 : _b7.call(this);
      }
    }
...
var { component, createContext } = haunted({ render: render2 });
